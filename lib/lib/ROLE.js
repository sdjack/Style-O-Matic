 ...
 * @type {Array}
 */
var NON_INHERITABLE = [ROLE.DEFAULT, ROLE.GROUP, ROLE.CONTENT, ROLE.DRAWER, ROLE.FOLDERITEM, ROLE.ITEM, ROLE.TEXT, ROLE.ICON, ROLE.CELL, ROLE.ROW, ROLE.INPUT, ROLE.COLUMN, ROLE.WIDGET];
/**
 * [NON_INHERITING description]
 * @type {Array}
 */
var NON_INHERITING = [ROLE.ACCORDION, ROLE.APP, ROLE.BREADCRUMBS, ROLE.CARD, ROLE.DATEPICKER, ROLE.GRID, ROLE.MODAL, ROLE.PAGINATION, ROLE.TABLE, ROLE.TOASTS, ROLE.TOOLBAR, ROLE.TOOLTIP];
/**
 * [THEME_ENABLED description]
 * @type {Array}
 */
var THEME_ENABLED = [ROLE.DEFAULT, ROLE.GROUP, ROLE.CONTENT, ROLE.FOLDERITEM, ROLE.ITEM, ROLE.TEXT, ROLE.ICON, ROLE.CELL, ROLE.ROW, ROLE.INPUT, ROLE.COLUMN, ROLE.WIDGET];
/**
