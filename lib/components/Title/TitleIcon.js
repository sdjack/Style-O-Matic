...
var TitleIcon = (_temp = _class = function (_CoreComponent) {
  _inherits(TitleIcon, _CoreComponent);

  function TitleIcon() {
    _classCallCheck(this, TitleIcon);

    return _possibleConstructorReturn(this, _CoreComponent.apply(this, arguments));
  }

  TitleIcon.prototype.render = function render() {
