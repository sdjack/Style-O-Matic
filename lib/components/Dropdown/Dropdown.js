...
var Dropdown = (_temp = _class = function (_CoreComponent) {
  ...
  Dropdown.prototype.componentWillUpdate = function componentWillUpdate(nextProps, nextState) {
    if (!nextState.active && this.state.active && this.node) {
      this.focusInDropdown = (0, _contains2.default)(this.node, (0, _activeElement2.default)(document));
    }
  };
  ...
  return Dropdown;
}(_lib.CoreComponent), _class.defaultProps = (0, _lib.setPropDefaultsAutoId)({
  renderAs: "div",
  uirole: _lib.ROLE.DROPDOWN
}), _class.Toggle = _DropdownToggle2.default, _class.List = _DropdownList2.default, _initialiseProps = function _initialiseProps() {
  var _this3 = this;

  this.handleOnToggle = function (e) {
    if ((0, _lib.isModifiedEvent)(e) || !(0, _lib.isLeftClickEvent)(e) || !_this3.state.active) {
      return;
    }
  ...
  this.toggleOpen = function (event, eventDetails) {
    ...
    if (_this3.props.onToggle) {
      _this3.props.onToggle(active, event, eventDetails);
    }
  };
  ...
  this.renderContent = function (child, _ref2) {
    ...
    return (0, _react.cloneElement)(child, _extends({}, props, {
      ref: ref,
      id: "list_" + id,
      uiclass: _this3.childPrefix("list"),
