...
var ToolBarText = (_temp = _class = function (_CoreComponent) {
  _inherits(ToolBarText, _CoreComponent);
  ...
  ToolBarText.prototype.render = function render() {
