...
var ToolBarContent = (_temp = _class = function (_CoreComponent) {
  _inherits(ToolBarContent, _CoreComponent);
  ...
  ToolBarContent.prototype.render = function render() {
    var _this2 = this;
...
exports.default = ToolBarContent;
