...
var TabToggle = (_temp = _class = function (_CoreComponent) {
  _inherits(TabToggle, _CoreComponent);

  function TabToggle() {
    _classCallCheck(this, TabToggle);

    return _possibleConstructorReturn(this, _CoreComponent.apply(this, arguments));
  }

  TabToggle.prototype.render = function render() {
