...
var NavItem = (_temp = _class = function (_CoreComponent) {
  ...
  NavItem.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      uirole !== _lib.ROLE.FOLDERITEM ? _react2.default.createElement("span", { className: "ui-nav-item-icon " + iconClassName }) : null,
      to ? _react2.default.createElement(
        "a",
        { className: "ui-nav-item-content", href: to, label: label },
        contents
